...
What it does, in order:
  ...
  6. Web       optionally forks Verity Meetings (booking pages) and Verity Chat (a chat
               widget for your site), seeds their facts, proves each boots locally, and
               hands the deploy to your assistant
  7. Report    says what it did, and what to do next
...
Options:
  ...
  --meetings           also set up Verity Meetings, booking pages on your own domain (same default)
  --chat               also set up Verity Chat, a chat widget for your website (same default)
...
export function parseArgs(argv) {
  ...
  for (let i = 0; i < argv.length; i++) {
    ...
    else if (t === "--meetings") a.meetings = true;
    else if (t === "--no-meetings") a.meetings = false;
    else if (t === "--chat") a.chat = true;
    else if (t === "--no-chat") a.chat = false;
